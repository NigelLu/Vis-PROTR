...
from src.model.backbone.pvt_v2 import pvt_v2_b2, pvt_v2_b3
...
class PVTWrap(nn.Module):
    def __init__(self, args):
        super().__init__()
        assert args.arch in ('pvt_v2_b2', 'pvt_v2_b3')
        pvt_func = pvt_v2_b2 if args.arch.endswith('b2') else pvt_v2_b3
        self.arch = args.arch
        self.feats_type = args.feats_type
        self.pvt = pvt_func(pretrained=args.pretrained, img_size=args.image_size)
        self.fpn = FeaturePyramidNetwork(args.fpn_in, args.fpn_out)
